...
public class CrudOperation {
    public void addEntity(long id, Student student) {
    ...
    public void deleteEntity(StudentDetails student) {
    ...
    public void updateEntity(long id, Student student) {
        OfyHelper.ofy().save().entity(
                new StudentDetails(id, student.name, student.registerNo, student.password, student.age, student.marks))
                .now();
    }

    public void patchEntity(StudentDetails entity, Student student) {
    ...
    public Query<StudentDetails> getAllEntities() {
    ...
    public StudentDetails getEntity(int id) {
